...
\usepackage{url}
\usepackage{tocloft}             % Paket fÃ¼r Table of Contents
...
\usepackage{mdwlist}     % Ã„nderung der ZeilenabstÃ¤nde bei itemize und enumerate
%\usepackage{draftwatermark} % Wasserzeichen ``Entwurf'' 
%\SetWatermarkText{Entwurf}

\usepackage{blindtext}
\parindent 0pt                 % AbsatzeinrÃ¼cken verhindern
\parskip 12pt                 % AbsÃ¤tze durch LÃ¼cke trennen
...
% aber auch der RÃ¼ckung der Wissenschaft in den Ã¶ffentlichen Blickpunkt
