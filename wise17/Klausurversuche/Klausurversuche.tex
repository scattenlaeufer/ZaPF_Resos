...
\usepackage{url}
\usepackage{tocloft}             % Paket fï¿½r Table of Contents
...
\usepackage{mdwlist}     % ï¿½nderung der Zeilenabstï¿½nde bei itemize und enumerate
%\usepackage{draftwatermark} % Wasserzeichen ``Entwurf'' 
%\SetWatermarkText{Entwurf}

\usepackage{blindtext}
\parindent 0pt                 % Absatzeinrï¿½cken verhindern
\parskip 12pt                 % Absï¿½tze durch Lï¿½cke trennen

%\usepackage{titlesec}    % Abstand nach ï¿½berschriften neu definieren
